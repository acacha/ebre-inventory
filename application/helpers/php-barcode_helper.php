<?
/*
 * Modified by Sergi Tur Badenas:
 * 
 * Globals not working, so I quit them
 * 
 * PHP-Barcode 0.4
...
function barcode_encode($code,$encoding){
	...
	print "php-barcode needs dasdsa an external programm for encodings other then EAN/ISBN<BR>\n";
	print "<ul>\n";
