 ...
 <div class="alert alert-sucess ">
  <a class="close" href="#" data-dismiss="alert"> x </a>
   ...
   <?php echo lang('user_preferences_admin message2');?>
    <a class="go-to-edit-form" href="<?php echo base_url('index.php/main/user_preferences/read') . "/" 
    . $user_preferences_id; ?>">
	 <?php echo lang('here');?>
	</a>
	<br/>
	<?php echo lang('user_preferences_admin message3');?>
	<a class="go-to-edit-form" href="<?php echo base_url('index.php/main/user_preferences/edit') . "/"
	. $user_preferences_id; ?>">
	 <?php echo lang('here');?>
	</a>
 </div>
