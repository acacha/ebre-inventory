	...
	function index()
	{
		...
		if (!$this->ion_auth->logged_in())
		{
			//redirect them to the login page
			 $this->load->view('auth/login_form', 'refresh');
		}
	...
	function login()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				$session_id = $this->input->post('identity');
				
				$this->session->set_userdata('session_id',$session_id);
				
				
				redirect('main/inventory', 'refresh');
			...
			else
			{
				...
				$this->session->set_flashdata('message', $this->ion_auth->errors());
				 $this->load->view('auth/login_form', 'refresh'); //use redirects instead of loading views for compatibility with MY_Controller libraries
			}
		}
		else
		{
			...
			$this->_render_page('auth/login_form', $this->data);
		}
	}
