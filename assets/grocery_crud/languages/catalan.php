...
/* Translated by Josep Llaó i Sergi Tur */
	...
	$lang['update_success_message']	= 'Els canvis van ser aplicats correctament.';                
	$lang['form_go_back_to_list']	= 'Tornar a la llista';

	$lang['form_add']				= 'Agregar';
	$lang['insert_success_message']	= 'Les dades van ser inserides correctament en la Base de dades.';
	$lang['form_or']				= 'o';
	...
	$lang['delete_success_message']	= 'Les dades van ser esborrades correctament en la Base de dades.';
	$lang['delete_error_message']	= 'Les dades no van poder ser esborrats de la Base de dades.';

	/* Javascript messages */
	$lang['alert_add_form']			= 'Les dades que vas inserir no poden ser guardats.\\nEstas segur que vols tornar a la llista?';
	$lang['alert_edit_form']		= 'Les dades que vas inserir no han estat guardats.\\nEstas segur que vols tornar a la llista?';
	...
	$lang['message_prompt_delete_file'] 	= "Aquesta segur que desitja esborrar l'arxiu?";
	
	$lang['error_max_number_of_files'] 	= "Solament pot pujar un arxiu alhora.";
	$lang['error_accept_file_types'] 	= "No aquesta permès pujar arxius amb aquesta extensió.";
	$lang['error_max_file_size'] 		= "El archivo subido excede el tamaño máximo permitido: {max_file_size}.";
	$lang['error_min_file_size'] 		= "No pot pujar un arxiu buit";
	...
	$lang['OwnerOrganizationalUnit'] = 'Unitats Organitzatives';
